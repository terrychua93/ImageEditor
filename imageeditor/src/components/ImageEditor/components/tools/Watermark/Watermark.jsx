...
import ButtonWithMenu from '@/components/ImageEditor/components/common/ButtonWithMenu';
import TextControls from '@/components/ImageEditor/components/tools/Text/TextOptions/TextControls';
import ImageControls from '@/components/ImageEditor/components/tools/Image/ImageControls';
import { usePhoneScreen, useStore } from '@/components/ImageEditor/hooks';
import { FEEDBACK_STATUSES, TOOLS_IDS } from '@/components/ImageEditor/utils/constants';
import HiddenUploadInput from '@/components/ImageEditor/components/common/HiddenUploadInput';
import {
...
const Watermark = () => {
  ...
  return (
    <div className="FIE_watermark-tool-wrapper">
      ...
      {watermark?.name === TOOLS_IDS.RISKTEXT && (
        <StyledControlsWrapper className="FIE_watermark-options-wrapper">
          <TextControls
            text={watermark}
            saveText={updateWatermarkOptions}
