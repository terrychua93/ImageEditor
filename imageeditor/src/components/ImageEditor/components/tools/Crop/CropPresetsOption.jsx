...
import { SET_CROP, SET_RESIZE, ZOOM_CANVAS } from '@/components/ImageEditor/actions';
import { useStore } from '@/components/ImageEditor/hooks';
import { StyledToolsBarItemButtonLabel } from '@/components/ImageEditor/components/ToolsBar/ToolsBar.styled';
import { DEFAULT_ZOOM_FACTOR, TOOLS_IDS } from '@/components/ImageEditor/utils/constants';
import toPrecisedFloat from '@/components/ImageEditor/utils/toPrecisedFloat';
import getZoomFitFactor from '@/components/ImageEditor/utils/getZoomFitFactor';
