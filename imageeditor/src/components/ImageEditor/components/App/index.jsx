...
import MainCanvas from '@/components/ImageEditor/components/MainCanvas';
import { ROOT_CONTAINER_CLASS_NAME } from '@/components/ImageEditor/utils/constants';
import Topbar from '@/components/ImageEditor/components/Topbar';
import Tabs from '@/components/ImageEditor/components/Tabs';
import ToolsBar from '@/components/ImageEditor/components/ToolsBar';
import {
  HIDE_LOADER,
  SET_FEEDBACK,
  SET_ORIGINAL_IMAGE,
  SHOW_LOADER,
  UPDATE_STATE,
} from '@/components/ImageEditor/actions';
import FeedbackPopup from '@/components/ImageEditor/components/FeedbackPopup';
import loadImage from '@/components/ImageEditor/utils/loadImage';
import delayTimer from '@/components/ImageEditor/utils/delayTimer';
import {
  usePhoneScreen,
  useResizeObserver,
  useStore,
  useTransformedImgData,
} from '@/components/ImageEditor/hooks';
import Spinner from '@/components/ImageEditor/components/common/Spinner';
import { getBackendTranslations } from '@/components/ImageEditor/utils/translator';
import cloudimageQueryToDesignState from '@/components/ImageEditor/utils/cloudimageQueryToDesignState';
import finetunesStrsToClasses from '@/components/ImageEditor/utils/finetunesStrsToClasses';
import filterStrToClass from '@/components/ImageEditor/utils/filterStrToClass';
import isSameImage from '@/components/ImageEditor/utils/isSameImage';
import {
  StyledAppWrapper,
  StyledMainContent,
