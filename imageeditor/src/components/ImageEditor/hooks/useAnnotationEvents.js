...
import { SET_ANNOTATION, SELECT_ANNOTATION, SELECT_TOOL } from '@/components/ImageEditor/actions';
import {
  TOOLS_IDS,
  TABS_IDS,
...
const useAnnotationEvents = () => {
  ...
  const getAnnotationTransformProps = useCallback((e) => {
    ...
    if (e.target.name() === TOOLS_IDS.TEXT || e.target.name() === TOOLS_IDS.RISKTEXT) {
