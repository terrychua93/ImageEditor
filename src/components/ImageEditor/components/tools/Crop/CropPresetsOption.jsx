...
import { SET_CROP, SET_RESIZE, ZOOM_CANVAS } from '../../../../ImageEditor/actions';
import { useStore } from '../../../../ImageEditor/hooks';
import { StyledToolsBarItemButtonLabel } from '../../../../ImageEditor/components/ToolsBar/ToolsBar.styled';
import { DEFAULT_ZOOM_FACTOR, TOOLS_IDS } from '../../../../ImageEditor/utils/constants';
import toPrecisedFloat from '../../../../ImageEditor/utils/toPrecisedFloat';
import getZoomFitFactor from '../../../../ImageEditor/utils/getZoomFitFactor';
